...
const reviews = [
  {
    quote: "I had the pleasure of mentoring Mowa, a talented and thoughtful product designer with a strong mix of product thinking and craft. She's incredibly proactive and dedicated, always taking feedback seriously, applying it quickly, and continuously refining her work. Mowa brings a strong understanding of product metrics, solid research skills, and a great eye for UI, all clearly reflected in her portfolio and past projects. She came to every conversation prepared, curious, and open to learning. I'd highly recommend her to any team looking for a skilled and motivated product designer.",
    author: "Arielle Ferreira",
    role: "Lead Product Designer at JobGet",
    photoSrc: "/about/arielle.jpeg",
    photoRotate: "5deg",
    tapeRotate: "-2deg",
  },
  {
    quote: "I had the pleasure of working with Mowa, and she is an exceptionally talented product designer. She has the ability to bring a product or idea to life, even when given minimal information. She is highly attentive, professional, and takes the time to understand your perspective, the feasibility of features, and other important details. On top of that, she's a joy to work with personally, and I genuinely enjoy collaborating with her.",
    author: "Tolu Okunjoyo",
    role: "Frontend Engineer at Qudra",
    photoSrc: "/about/tolu.jpeg",
    photoRotate: "-6deg",
    tapeRotate: "2deg",
  },
  {
    quote: "I had the pleasure of working with Mowa on several major projects, including Build Core, Build Africa Store, and Build Africa AI. Her design skills are exceptional, and she consistently delivers clean, user-focused solutions. Mariam is reliable, collaborative, and brings a positive attitude to every task, truly every team's dream colleague. She excels both as a professional and as a person, and I confidently recommend her as a Product Designer.",
...
const PROJECT_DATA: Record<string, {
  title: string; subtitle: string; headline: string; role: string; duration: string; platform?: string;
  ...
  'Fox Holistic Care': {
    ...
    thumbnail: '/f-o.jpg',
    sections: [
      { type: 'asset', label: 'Hero Mockup', image: '/f-o.jpg', desc: 'Mobile home page and desktop booking preview. Warm, inviting tone.' },
      ...
      { type: 'asset', label: 'Component Closeup', image: '/Little details.png', desc: 'Sparkle star micro-interaction in the navigation bar.' },
  ...
  'Build Africa AI': {
    ...
    sections: [
      { type: 'asset', label: 'Hero Mockup', image: '/build-africa-ai.jpg', desc: 'Build Africa AI — 3D building visualisation alongside AI cost breakdown.' },
      ...
      { type: 'asset', label: 'Final Product Showcase', image: '/Jitter-1.gif', desc: 'Platform flow — dimension input, 2D floor plan, 3D model, cost estimate.' },
      ...
      { type: 'asset', label: 'BOQ Before After', image: '/BOQ.png', desc: 'Manual Excel BOQ — weeks of specialist work, prone to inflation errors before delivery.' },
      ...
      { type: 'asset', label: 'Cost Estimation Screen', image: '/Cost estimate and Moq.png', desc: 'AI cost estimation — real-time pricing, material breakdown, inflation-adjusted totals.' },
      ...
      { type: 'asset', label: '🎨 Strategy Architecture', image: '/3D image.jpg', desc: '3D view with unified AI toolbar — Design, Material Estimate, and Ask Build AI in one place.' },
  ...
  'She': {
    ...
    thumbnail: '/she.jpg',
    sections: [
      { type: 'asset', label: 'Hero Mockup', image: '/she.jpg', desc: 'Redesigned landing page with sidebar cart. Premium African-centric jewellery aesthetic.' },
      ...
      { type: 'asset', label: '🎨 New Layout Strategy', image: '/she-landing-page.jpg', desc: 'Redesigned landing page — clear visual hierarchy, immediate path to shopping.' },
      ...
      { type: 'asset', label: 'Sidebar Cart Experience', image: '/she-overlay.jpg', desc: 'Single-page shopping — browsing, cart, and checkout on one screen.' },
      ...
      { type: 'asset', label: 'Professional Photography', image: '/she-proff.png', desc: 'African-centric product photography — the visual foundation the brand required.' },
      ...
      { type: 'asset', label: 'Final Product Showcase', image: '/she-mockup.jpg', desc: 'Finished SHE platform — sidebar cart and African-centric jewellery photography.' },
    ...
    <div className={`relative ${compact ? 'w-52' : 'w-72'}`} style={{ paddingTop: compact ? '42px' : '52px' }}>
      ...
      <div className="relative w-full bg-white shadow-md border border-black/5 rounded-sm z-20 flex flex-col items-center py-5 gap-3">
        ...
        <div className="flex gap-5 items-start">
          ...
          <div className="flex flex-col items-center gap-1.5">
            <a
              href="https://www.linkedin.com/in/mowa-otun"
              target="_blank"
              rel="noreferrer"
          ...
          <div className="flex flex-col items-center gap-1.5">
            <a
              href="https://docs.google.com/document/d/1JdjM8DPoPfcUpyfOsIuf_w51LAALdnKuwbvc_pSPJIw/edit?usp=sharing"
              target="_blank"
              rel="noreferrer"
...
const PathButterfly = ({
  ...
  const imgSize = size === 'text-lg' ? 'w-5 h-5' : 'w-7 h-7';
  return (
    <motion.div
      className={`absolute pointer-events-none select-none z-[8] ${className}`}
    ...
    >
      <img src="/about/butterfly.png" alt="" className={`${imgSize} object-contain`} draggable={false} />
    </motion.div>
  );
};
...
// Tool logo assets styled to match the scrapbook sticker system
const ToolLogoImage = ({ src, alt }: { src: string; alt: string }) => (
  <div className="w-10 h-10 rounded-xl overflow-hidden bg-[#fffaf0] border border-black/5 shadow-[inset_0_1px_0_rgba(255,255,255,0.55)]">
    <img src={src} alt={alt} className="w-full h-full object-cover" draggable={false} />
  </div>
);

const FramerLogo = () => (
  <svg viewBox="0 0 24 36" width="16" height="24" aria-hidden="true">
    {/* Official Framer F mark */}
    <path d="M0 0H24V12H12L0 0Z" fill="white"/>
    <path d="M0 12H12L24 24H12V12H0Z" fill="rgba(255,255,255,0.7)"/>
    <path d="M0 24H12V36L0 24Z" fill="white"/>
  </svg>
);
  ...
  const toolStickers = [
    {
      ...
      rotate: '-2.5deg',
      logo: <ToolLogoImage src={figmaLogo} alt="Figma logo" />,
    },
    {
      name: 'Claude Code',
      ...
      rotate: '2deg',
      logo: <ToolLogoImage src={claudeLogo} alt="Claude logo" />,
    },
    {
      name: 'Framer',
      note: 'motion & magic',
    ...
    },
    {
      ...
      rotate: '2deg',
      logo: <ToolLogoImage src={cursorLogo} alt="Cursor logo" />,
    },
    {
      name: 'Notion',
  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-16 lg:px-28 pt-24 pb-32">
        ...
        {/* ── Hero: portrait + intro (side-by-side on desktop) ── */}
        <motion.div
          initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.1, duration: 0.7 }}
          className="mb-20 flex flex-col lg:flex-row gap-12 lg:gap-16 items-start"
        >
          {/* Portrait polaroid */}
          <div className="flex-shrink-0">
            ...
            >
              <img
                ...
                alt="Mowa Otun"
                className="w-[260px] sm:w-[300px] h-[340px] sm:h-[380px] object-cover object-top"
                draggable={false}
              />
          ...
          <div className="flex-1 lg:pt-4">
            <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-sky-600 font-medium mb-4">About me</p>
            <h1 className="font-gelica text-5xl lg:text-6xl text-ink font-semibold leading-tight mb-2">Mowa Otun</h1>
            <p className="font-satoshi text-base text-ink/50 italic mb-2">Product & UX Designer · Toronto, Canada</p>
            <p className="font-gelica text-xl lg:text-2xl text-plum/80 italic leading-snug mb-8">
              Designing experiences people<br className="hidden lg:block" /> actually <em>want</em> to use.
            </p>
            <div className="space-y-4 mb-8">
              <p className="font-satoshi text-base text-ink leading-relaxed">
                I've spent 4+ years designing across AI, Healthcare, B2B SaaS, and B2C, building products that actually solve problems instead of just checking boxes. My sweet spot is finding the balance between what users need and what a business needs to thrive. When I'm not deep in Figma, you'll find me out in the world meeting new people and immersing myself in new cultures.
              </p>
              <p className="font-satoshi text-base text-ink leading-relaxed">
              ...
              <p className="font-satoshi text-sm text-ink/50 leading-relaxed italic">
                Based in Toronto. Always up for connecting with teams building something meaningful.
              </p>
            </div>
            {/* Skill chips */}
            <div className="flex flex-wrap gap-2">
              {['UX Research', 'UI Design', 'Product Strategy', 'Design Systems', 'Interaction Design', 'Prototyping', 'AI Products'].map((skill, i) => {
                ...
                return <span key={skill} className={`font-mono text-[9px] uppercase tracking-widest px-3 py-1.5 border rounded-full ${c[i % c.length]}`}>{skill}</span>;
              })}
            </div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="mb-20 bg-white border border-black/6 rounded-2xl p-6 shadow-sm relative overflow-hidden"
        >
          <img
            src="/about/butterfly-opener.png"
            alt=""
            aria-hidden="true"
            className="absolute top-4 right-5 w-7 h-7 opacity-20 select-none object-contain"
            draggable={false}
          />
          <p className="font-gelica text-xl text-ink leading-relaxed mb-4">
            ...
            <img
              ...
              alt=""
              aria-hidden="true"
              className="inline-block w-6 h-6 object-contain align-[-0.15em]"
              draggable={false}
            />
          </p>
        ...
        <motion.div
          ...
          className="mb-20"
        >
          <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-sky-600 font-medium mb-6">A peek into my world 💕</p>
        ...
        {/* ── 6. Tools — desk stickers ── */}
        <motion.div
          initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.44, duration: 0.6 }}
          className="mb-20"
        >
          <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-sky-600 font-medium mb-6">My desk</p>
        ...
        >
          ...
          <div className="bg-white p-7 rounded-2xl border border-black/6 shadow-sm flex flex-col justify-between gap-5">
            <div>
              <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-plum font-medium mb-2">Say hello</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-x-16 gap-y-24 items-start">
          {projects.map((p, i) => (
            ...
            >
              ...
              <p className="font-mono text-[9px] uppercase tracking-widest text-ink/30 group-hover:text-sky-vivid transition-colors duration-200 text-center mt-3">
                Open Case Study →
              </p>
            </motion.button>
          ))}
...
const ProjectPage = ({ projectKey, onClose, onOpenProject }: { projectKey: string; onClose: () => void; onOpenProject: (key: string) => void }) => {
  ...
  React.useEffect(() => {
    const handler = (e: KeyboardEvent) => { if (e.key === 'Escape') setZoomedImg(null); };
  ...
  return (
    ...
    >
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 z-[600] w-11 h-11 rounded-full bg-white border border-black/10 shadow-md flex items-center justify-center text-sky/55 hover:text-sky hover:shadow-lg hover:scale-105 transition-all duration-200 cursor-pointer"
        >
      ...
      <div className="hidden lg:block fixed left-[90px] top-6 w-44 max-h-[calc(100vh-2rem)] overflow-y-auto z-[450]">
              ...
              {h2Sections.map((section) => (
                <button
                  ...
                  className={`group flex items-center gap-3 w-full text-left py-2 transition-all duration-200 ${
                    activeSection === section.id ? 'text-sky-vivid' : 'text-ink/35 hover:text-ink/65'
                  }`}
                >
        ...
        >
          ...
          <div className="flex flex-wrap gap-10 pt-8 border-t border-black/8">
            ...
            {p.platform && (
              <div>
                <p className="font-mono text-[9px] uppercase tracking-widest text-ink/35 mb-1">Platform</p>
                <p className="font-satoshi text-sm text-ink">{p.platform}</p>
              </div>
            )}
          </div>
        </motion.div>
        ...
        {p.sections.map((section, i) => (
          ...
          >
            ...
            {section.type === 'asset' && section.image && (section.label === 'Interaction Demo' || section.label === 'Booking Demo') && projectKey === 'Fox Holistic Care' && (
              <div className="w-full flex flex-col" style={{ background: '#e8f5f3' }}>
                <video src={section.image} className="w-full h-auto" controls autoPlay loop muted playsInline />
                {section.desc && (
                  <p className="font-satoshi text-xs text-ink/40 text-center mt-4 italic px-8 pb-6 leading-relaxed">{section.desc}</p>
                )}
              </div>
            )}
            ...
            {section.type === 'asset' && section.image && section.label === '🎨 Strategy Visualization' && projectKey === 'Fox Holistic Care' && (
              <div className="w-full bg-white border border-ink/8 flex flex-col items-center py-10 px-8">
                <div className="w-full max-w-sm border-2 border-ink/12 rounded-2xl overflow-hidden shadow-md">
                  <img src={section.image} alt={section.label} className="w-full h-auto object-cover rounded-2xl cursor-zoom-in" draggable={false} onClick={() => setZoomedImg(section.image!)} />
                </div>
                {section.desc && (
            ...
            {section.type === 'asset' && section.image && section.label === 'Component Closeup' && projectKey === 'Fox Holistic Care' && (
              <div className="w-full bg-white border border-ink/8 flex flex-col items-center py-10 px-8">
                <img src={section.image} alt={section.label} className="w-full max-w-md h-auto object-contain cursor-zoom-in" draggable={false} onClick={() => setZoomedImg(section.image!)} />
                {section.desc && (
                  <p className="font-satoshi text-xs text-ink/40 text-center mt-5 italic max-w-xs leading-relaxed">{section.desc}</p>
                )}
              </div>
            ...
            {section.type === 'asset' && section.label === 'Cost Estimation Screen' && projectKey === 'Build Africa AI' && (
              <div className="w-full flex flex-col items-center py-10 px-8" style={{ background: '#000000' }}>
                ...
                {section.desc && (
                  <p className="font-satoshi text-xs text-white/80 text-center mt-5 italic max-w-xs leading-relaxed">{section.desc}</p>
                )}
              </div>
            )}
            ...
            {section.type === 'asset' && section.image && !(section.label === '🎨 Strategy Visualization' && projectKey === 'Fox Holistic Care') && !(section.label === 'Component Closeup' && projectKey === 'Fox Holistic Care') && !((section.label === 'Interaction Demo' || section.label === 'Booking Demo') && projectKey === 'Fox Holistic Care') &&
              ...
              <div className="bg-white p-3 pb-8 shadow-sm border border-gray-200/60 relative">
                ...
                <img src={section.image} alt={section.label} className="w-full h-auto object-cover cursor-zoom-in" onClick={() => setZoomedImg(section.image!)} />
                {section.desc && (
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex flex-col gap-2">
                    <div className="rounded-xl overflow-hidden shadow-sm border border-ink/8">
                      <img src={section.image} alt={section.label + ' A'} className="w-full h-auto object-cover cursor-zoom-in" draggable={false} onClick={() => setZoomedImg(section.image!)} />
                    </div>
                    {section.label === 'Iteration Collage' && (
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="rounded-xl overflow-hidden shadow-sm border border-ink/8">
                      <img src={(section as any).image2} alt={section.label + ' B'} className="w-full h-auto object-cover cursor-zoom-in" draggable={false} onClick={() => setZoomedImg((section as any).image2)} />
                    </div>
                    {section.label === 'Iteration Collage' && (
            ...
            {section.type === 'asset' && section.image && section.label === 'BOQ Before After' && projectKey === 'Build Africa AI' && (
              <div className="w-full bg-white border border-ink/8 flex flex-col items-center py-10 px-8">
                <div className="w-full max-w-lg rounded-2xl overflow-hidden shadow-md border-2 border-ink/12">
                  <img src={section.image} alt="Old BOQ" className="w-full h-auto object-cover cursor-zoom-in" draggable={false} onClick={() => setZoomedImg(section.image!)} />
                </div>
            ...
            {section.type === 'h2' && (
              ...
              >
                {section.sectionLabel && (
                  <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-sky-600 font-medium mb-2">{section.sectionLabel}</p>
                )}
                <h2 className="font-gelica text-2xl md:text-3xl text-ink leading-snug mb-4">{section.heading}</h2>
                <p className="font-satoshi text-base text-ink leading-relaxed">{renderBody(section.body || '')}</p>
              </div>
            )}
            ...
            {section.type === 'h3-list' && (
              <div>
                <h3 className="font-gelica text-xl text-sky-600 mb-4">{section.heading}</h3>
                <ul className="space-y-2.5">
                  {section.items.map((item, j) => (
                    <li key={j} className="flex items-start gap-3">
                      <span className="mt-2 w-1.5 h-1.5 rounded-full bg-plum/60 flex-shrink-0" />
              ...
              <div className="grid grid-cols-2 gap-4">
                {section.items.map((stat, j) => (
                  <div key={j} className="bg-white border border-black/8 shadow-sm p-6 relative overflow-hidden">
                    ...
                    />
                    <p className="font-gelica text-3xl text-sky-600 leading-none mb-2">{stat.value}</p>
            ...
            {section.type === 'pullquote' && (
              <blockquote className="pl-5 py-1 font-gelica text-xl md:text-2xl text-plum leading-snug italic border-l-[3px] border-sky">
                {section.text}
              </blockquote>
            )}
            ...
            {section.type === 'bold-bullets' && (
              <div>
                ...
                <ul className="space-y-3">
                  {section.items.map((item, j) => (
                    <li key={j} className="flex items-start gap-3">
                      <span className="mt-2 w-1.5 h-1.5 rounded-full bg-plum/50 flex-shrink-0" />
      ...
      {zoomedImg && (
        <div
          className="fixed inset-0 z-[900] bg-black/85 flex items-center justify-center p-4 cursor-zoom-out"
...
const MobileLayout = ({
  ...
  return (
    ...
    >
      ...
      <motion.div className="fixed top-0 left-0 drop-shadow-md z-[800] pointer-events-none" initial={{ opacity: 0, x: '50vw', y: '60vh', rotate: -15, scale: 0.8 }} animate={{ opacity: [0, 1, 1, 1, 0], x: ['50vw', '45vw', '55vw', '80vw', '110vw'], y: ['60vh', '45vh', '55vh', '20vh', '-10vh'], rotate: [-15, 10, -20, 15, 30], scale: [0.8, 1.2, 1, 1.1, 0.8] }} transition={{ duration: 2.5, times: [0, 0.1, 0.4, 0.7, 1], ease: 'easeInOut', delay: 0.3 }}><img src="/about/butterfly.png" alt="" className="w-16 h-16 object-contain" draggable={false} /></motion.div>
      ...
      <div className="px-5 pt-2 pb-20">
        ...
        <div className="relative bg-white border border-black/5 shadow-md rounded-sm p-6 flex flex-col items-center gap-4" style={{ transform: 'rotate(0.3deg)' }}>
          ...
          <div className="flex gap-6 items-start">
            ...
            <div className="flex flex-col items-center gap-1.5">
              <a href="https://www.linkedin.com/in/mowa-otun" target="_blank" rel="noreferrer" className="w-12 h-12 rounded-full bg-sky/10 border border-sky/20 flex items-center justify-center text-sky shadow-sm">
                <Linkedin size={20} />
              </a>
              <span className="font-mono text-[9px] uppercase tracking-widest text-ink/50">LinkedIn</span>
            </div>
            <div className="flex flex-col items-center gap-1.5">
              <a href="https://docs.google.com/document/d/1JdjM8DPoPfcUpyfOsIuf_w51LAALdnKuwbvc_pSPJIw/edit?usp=sharing" target="_blank" rel="noreferrer" className="w-12 h-12 rounded-full bg-plum/10 border border-plum/20 flex items-center justify-center text-plum shadow-sm">
                <FileText size={20} />
              </a>
    ...
    <>
      ...
      >
        ...
        <motion.div
          ...
          className="fixed top-0 left-0 drop-shadow-md z-[100] pointer-events-none -translate-x-1/2 -translate-y-1/2"
        >
          <img src="/about/butterfly.png" alt="" className="w-16 h-16 object-contain" draggable={false} />
        </motion.div>
        ...
        <motion.div
          ...
          className="fixed top-0 left-0 drop-shadow-md z-[90] pointer-events-none -translate-x-1/2 -translate-y-1/2"
        >
          <img src="/about/butterfly.png" alt="" className="w-14 h-14 object-contain" draggable={false} />
        </motion.div>
        ...
        <motion.div
          ...
          className="fixed top-0 left-0 drop-shadow-md z-[90] pointer-events-none -translate-x-1/2 -translate-y-1/2"
        >
          <img src="/about/butterfly.png" alt="" className="w-12 h-12 object-contain" draggable={false} />
        </motion.div>
      ...
      {/* Reviews modal */}
      <AnimatePresence>
        {showReviewsModal && <ReviewsModal onClose={() => setShowReviewsModal(false)} initialIndex={reviewsModalIndex} />}
      </AnimatePresence>
